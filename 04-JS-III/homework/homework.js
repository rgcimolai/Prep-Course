...
function promedioResultadosTest(resultadosTest) {
  ...
  var suma = 0;
  var prom = 0;
    if ( Array.isArray (resultadosTest) === true){
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var array = [];
    array = numeros.sort (function (a , b){ return a - b})
      return array[array.length - 1]
}
...
function mesesDelAño(array) {
  ...
  if (mesesDelAño.length === 3){
      for (var j = 0 ; j < mesesDelAño.length - 1 ; j++){
            if(mesesDelAño[j] === mesesDelAño[j + 1]){
